    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              Container(
                ...
                height: 42,
                decoration: BoxDecoration(
                  color: theme.cardColor.withValues(alpha: .88),
          ...
          Text(
            'Raise a ticket and continue the same conversation thread.',
      ...
      child: InkWell(
        ...
        child: Ink(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                color: Colors.black.withValues(alpha: .026),
                blurRadius: 16,
                ...
                ...List<Widget>.generate(messages.length, (index) {
                  ...
                  return Padding(
                    padding: EdgeInsets.only(
                      bottom: index == messages.length - 1 ? 0 : 14,
                    ),
