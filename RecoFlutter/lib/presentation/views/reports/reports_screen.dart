...
class ReportsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = <ReportFeatureItem>[
      ...
      ReportFeatureItem(
        title: 'Trial Balance',
        subtitle: 'Basis for Balance Sheet and Profit & Loss with closing debit and credit balances.',
      ...
      ReportFeatureItem(
        title: 'Balance Sheet',
        subtitle: 'Assets, liabilities, and equity in a cleaner financial position statement.',
      ...
      ReportFeatureItem(
        ...
        subtitle: 'Debtors with debit balances on linked ledgers.',
      ...
      ReportFeatureItem(
        ...
        subtitle: 'Creditors with credit balances on linked ledgers.',
