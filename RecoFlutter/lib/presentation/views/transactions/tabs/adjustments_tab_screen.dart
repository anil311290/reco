...
class AdjustmentsTabScreen extends GetView<AdjustmentsController> {
  const AdjustmentsTabScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return TransactionTabContent<AdjustmentsController>(
      emptyText: 'No adjustment vouchers found',
      columnsBuilder: (context) => <DataColumn2>[
        ...
        masterColumn(context, 'Type', fixedWidth: 120),
      ...
      rowBuilder: (context, item, index) => DataRow(
        cells: <DataCell>[
          ...
          masterTextCell(item.typeLabel.isEmpty ? 'Adjustment' : item.typeLabel),
