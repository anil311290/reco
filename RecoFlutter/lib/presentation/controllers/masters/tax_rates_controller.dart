...
class TaxRatesController extends GetxController with MasterExportMixin {
  TaxRatesController(this._repository, this._exportRepository);
  ...
  Future<void> save(TaxRateEntity entity) async {
    if (entity.id == null) {
      ...
      AppSnackbar.success('Tax rate saved locally. Sync queue updated.');
    } else {
      await _repository.update(entity);
      AppSnackbar.success('Tax rate update queued successfully.');
    }
    await refreshData();
  }
