...
class CashBookReportController extends BaseReportController {
  CashBookReportController(super.repository, super.networkMonitorService);
  ...
  @override
  String get endpoint => ApiEndpoints.reportsCashBook;
  ...
  Future<void> _initialize() async {
    ...
    if (lookup.cashAccounts.isEmpty) {
      await lookup.loadCashBankAccounts();
    }
    accountId.value ??= _asInt(
      lookup.cashAccounts.isNotEmpty ? lookup.cashAccounts.first['id'] : null,
    );
    await loadReport();
  }
