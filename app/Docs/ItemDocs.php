 ...
 *     tags={"Items"},
 *     summary="Create item",
 *     description="item_code is generated by the server as ITEM-001, ITEM-002, etc. Do not send item_code. opening_stock sets the opening quantity. unit applies to goods only and is stored as null for services.",
 ...
 *         @OA\Property(property="unit", type="string", example="nos", description="Goods only; ignored for services"),
 ...
 *     tags={"Items"},
 *     summary="Update item",
 *     description="item_code is read-only. Updating opening_stock adjusts current_stock by the opening delta. unit applies to goods only and is stored as null for services.",
