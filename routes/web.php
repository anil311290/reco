    ...
    Route::middleware('auth')->group(function () {
        ...
        */
        Route::middleware(CheckPermission::class . ':vouchers.view')->group(function () {
            ...
            Route::post('sales-invoices/{id}/post', [SalesInvoiceController::class, 'post'])->name('sales-invoices.post');
        ...
        */
        Route::middleware(CheckPermission::class . ':vouchers.view')->group(function () {
            ...
            Route::post('purchase-invoices/{id}/post', [PurchaseInvoiceController::class, 'post'])->name('purchase-invoices.post');
