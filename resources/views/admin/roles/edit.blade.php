        ...
        <form id="roleForm" method="POST" action="{{ route('admin.roles.update', $role->id) }}">
            ...
            @foreach($permissions as $module => $modulePermissions)
                @php
                    ...
                    $allChecked = count(array_intersect($modulePermissionIds, $rolePermissionIds)) === count($modulePermissionIds);
                @endphp
                <div class="card mb-3">
...
$(document).ready(function() {
    ...
    // Form submission
    ajaxFormSubmit('roleForm', '{{ route("admin.roles.update", $role->id) }}', 'PUT', function(response) {
