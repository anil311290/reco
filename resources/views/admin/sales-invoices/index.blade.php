    ...
    <div class="card-body">
        <form id="filterForm" class="row g-3">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="search" placeholder="Invoice # or customer...">
            </div>
            <div class="col-md-3">
...
$(document).ready(function() {
    let table = $('#invoicesTable').DataTable({
        ...
        columns: [
            ...
            { data: 'balance_due', render: function(d, t, row) {
            ...
            { data: null, orderable: false, render: function(data) {
                ...
                if (data.status !== 'cancelled' && data.status !== 'paid') {
                    buttons += ` <a href="/admin/sales-invoices/${data.id}?open_payment=1#paymentModal" class="btn btn-sm btn-outline-success" title="Record Payment"><i class="bi bi-cash"></i></a>`;
                }
