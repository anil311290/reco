                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" name="due_date" value="{{ date('Y-m-d', strtotime('+1 month')) }}" required>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-md-3">
            <div class="card sticky-top" style="top:1rem">
                ...
                <div class="card-body p-2">
                    ...
                    <button type="submit" class="btn btn-primary w-100 mb-2" id="createInvoiceBtn" style="padding: 0.375rem;">
