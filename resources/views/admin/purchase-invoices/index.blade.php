    ...
    <div class="card-body">
        <form id="filterForm" class="row g-3">
            ...
            <div class="col-md-2 d-flex align-items-end">
                <button type="submit" class="btn btn-primary w-100"><i class="bi bi-search me-2"></i>Apply</button>
            </div>
        </form>
    </div>
</div>
...
$(document).ready(function() {
    let table = $('#invoicesTable').DataTable({
        ...
        columns: [
            ...
            { data: null, orderable: false, render: function(data) {
                ...
                buttons += ` <a href="/admin/purchase-invoices/create?duplicate=${data.id}" class="btn btn-sm btn-outline-secondary" title="Duplicate"><i class="bi bi-copy"></i></a>`;
    ...
    $('#invoicesTable').on('click', '.post-invoice-btn', function() {
        ...
        Swal.fire({
            ...
            $.ajax({
                url: `/admin/purchase-invoices/${id}/post`,
                type: 'POST',
