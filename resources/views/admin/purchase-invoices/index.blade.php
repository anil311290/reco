        ...
        columns: [
            ...
            { data: null, orderable: false, render: function(data) {
                ...
                if (data.status !== 'cancelled' && data.status !== 'paid') {
                    buttons += ` <a href="/admin/purchase-invoices/${data.id}?open_payment=1#paymentModal" class="btn btn-sm btn-outline-success" title="Record Payment"><i class="bi bi-cash"></i></a>`;
                }
