            ...
            <table class="table report-table table-hover mb-0">
                <thead>
                    <tr>
                        ...
                        @include('admin.reports._sort-th', ['field' => 'balance', 'label' => 'Balance (₹) Dr', 'align' => 'end'])
                    </tr>
                </thead>
                <tbody>
